...
@click.option(
    "--dataset_path",
    type=str,
    default="./calvin/dataset/task_D_D/training/",
)
@click.option(
    "--output_path",
    type=str,
    default="./calvin/dataset/task_D_D/training_tfrecords/",
)
...
def convert_calvin_dataset_to_tfrecord(
    dataset_path: str = "./calvin/dataset/task_D_D/training/",
    output_path: str = "./calvin/dataset/task_D_D/training_tfrecords/",
...
def create_goal_image_file(
    ...
    output_path: str = "./calvin/dataset/task_D_D/goal_image.npz",
    image_size: int = 100,
):
    transition_path = (
        f"./calvin/dataset/task_D_D/training/episode_{transition_index:07d}.npz"
    )
    transition = np.load(transition_path)
